...
test(
  'should reject duplicate email during registration',
  {
...
test(
  'should accept valid token in authorization header',
  {
...
test(
  'should enforce strong password policy when enabled',
  {
    tag: ['@auth', '@registration', '@validation'],
  },
  async ({ request }) => {
...
test(
  'should fetch own user profile successfully',
  {
...
// Update user profile
test(
  'should update user display name',
  {
...
test(
  'should retrieve financial account with balance',
  {
...
test(
  'should deny unauthenticated financial access',
  {
...
// Create transaction
test(
  'should create valid transaction',
  {
...
test(
  'should retrieve paginated transaction history',
  {
...
test(
  'should calculate financial statistics',
  {
...
test(
  'should generate PDF financial report',
  {
...
test(
  'should list available marketplace offers with pagination',
  {
...
// Create offer (seller)
test(
  'should create marketplace offer',
  {
...
// Purchase offer
test(
  'should purchase marketplace offer successfully',
  {
...
test(
  'should reject purchase with insufficient balance',
  {
...
test(
  'should prevent purchasing own offer',
  {
    tag: ['@marketplace', '@purchase', '@validation', '@negative'],
  },
  async ({ request, context }) => {
...
// List fields
test(
  'should list all user fields with metadata',
  {
...
// Create field
test(
  'should create new field with valid area data',
  {
...
// List animals
test(
  'should list all user animals with health status',
  {
...
// Add animal
test(
  'should register new animal in system',
  {
...
test(
  'should create staff-to-field assignment',
  {
...
test(
  'should prevent duplicate staff assignments to same field',
  {
...
test(
  'should return API version and info',
  {
...
test(
  'should enforce rate limiting on auth endpoints',
  {
...
// Rate limit tiers
test(
  'should apply different limits to different endpoint tiers',
  {
...
test(
  'should bypass rate limits for admin requests',
  {
...
// Input validation
test(
  'should reject invalid email format in registration',
  {
...
test(
  'should reject non-integer ID in URL',
  {
    tag: ['@validation', '@negative'],
  },
  async ({ request, context }) => {
...
test(
  'should require admin credentials for admin endpoints',
  {
...
test(
  'should allow admin to access admin dashboard',
  {
...
test(
  'should respect feature flags for endpoint availability',
  {
...
test(
  'should provide feature flag status in API response',
  {
